...
- [Appointment identity policy](appointment-identity-policy.md) — reuse unambiguous matches; conflicts require manual review; preserve existing data and access.

...
- Mount the raw-body router before the global JSON parser and export the new schema tables.
...
- Apply and independently verify migration `20260912_producer_calendly.sql`.

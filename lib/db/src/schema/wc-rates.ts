import { pgTable, uuid, text, date, numeric, timestamp, unique, index } from "drizzle-orm/pg-core";
...
export const wcRatesTable = pgTable("wc_rates", {
  ...
  unique("wc_rates_state_class_date").on(table.state, table.classCode, table.effectiveDate),

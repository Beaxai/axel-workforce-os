...
export function fromQuoteFlow(s: QuoteFlowSubset): CannabisApplicationAnswers {
  ...
  const answers: CannabisApplicationAnswers = {
    ...
    ...(() => {
      const hasDeliveryOp = has(s.cannabisOperations, "delivery");
      const noExposure = !hasDeliveryOp && s.drivingDeliveryExposureFlag === "No";
      if (noExposure) {
        // No driving/delivery exposure — flag every auto-exposure field as
        // N/A on the Trean / Axel applications instead of leaving them blank.
        return {
          drivingDeliveryExposure: "no" as const,
          drivingMileagePctLt50: "",
          drivingMileagePct50to100: "",
          drivingMileagePct100plus: "",
          drivingMileageNa: true,
          maxDeliveryMileage: "",
          deliveryRetailPct: "",
          deliveryWholesalePct: "",
          deliveryDirectPct: "",
          vehiclesGpsEquipped: "" as const,
          driversAge25to65: "" as const,
          driversOver65Count: "",
          totalDriverCount: "",
          hoursOfDelivery: "N/A",
          bicycleDelivery: "no" as const,
          bicycleDeliveryDetails: "",
          groupTransportationProvided: "no" as const,
          groupTransportationCount: "",
          vehiclesCompanyOwned: "" as const,
          vehiclesUnmarked: false,
          vehicleMaintenance: "" as const,
          distractedDrivingPolicy: "na" as const,
          driversTraining: "na" as const,
          cdlsRequired: "na" as const,
          overnightTravel: "no" as const,
          overnightTravelFrequency: "",
          avgDistancePerDayMin: "",
          avgDistancePerDayMax: "",
          avgDistanceNa: true,
          avgDeliveriesPerDayMin: "",
          avgDeliveriesPerDayMax: "",
          avgDeliveriesNa: true,
          outOfStateTransportStates: "N/A",
        };
      }
      return {

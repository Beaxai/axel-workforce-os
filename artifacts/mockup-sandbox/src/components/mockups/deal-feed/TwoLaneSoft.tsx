    ...
    <div className="min-h-screen bg-[#0d0d10] text-zinc-300 p-8 font-sans selection:bg-[#E91E8C]/30">
      <div className="max-w-[760px] mx-auto pb-20 flex flex-col gap-10">
        ...
        <section className="flex flex-col gap-3">
          <h3 className="text-zinc-500 text-[11px] font-semibold uppercase tracking-widest mb-2 pl-16">Today</h3>
          
          {/* Human Comment 1 */}
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-8 rounded-full bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-[11px] font-medium text-zinc-300 mt-1">
              SM
            </div>
            <div className="flex-1 flex flex-col bg-white/[0.03] rounded-2xl p-4">
        ...
        {/* Yesterday */}
        <section className="flex flex-col gap-3">
          <h3 className="text-zinc-500 text-[11px] font-semibold uppercase tracking-widest mb-2 pl-16">Yesterday</h3>

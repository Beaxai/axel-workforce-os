...
import { ArrowRight, Check, Circle, File, ShieldCheck } from 'lucide-react';

export function TwoLaneIcons() {
  return (
    <div className="min-h-screen bg-[#0d0d10] text-zinc-300 p-8 font-sans selection:bg-[#E91E8C]/30">
      <div className="max-w-[760px] mx-auto pb-20 flex flex-col gap-10">
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-6 flex justify-center items-center">
              <ArrowRight className="w-3.5 h-3.5 text-zinc-600" strokeWidth={2} />
            </div>
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-6 flex justify-center items-center">
              <Circle className="w-3.5 h-3.5 text-zinc-600" strokeWidth={2} />
            </div>
            <div className="flex-1 flex items-center justify-between">
              <p className="text-[13px] text-zinc-500 leading-6">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-6 flex justify-center items-center">
              <File className="w-3.5 h-3.5 text-zinc-600" strokeWidth={2} />
            </div>
            <div className="flex-1 flex items-center justify-between">
              <p className="text-[13px] text-zinc-500 leading-6">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-6 flex justify-center items-center">
              <Check className="w-3.5 h-3.5 text-zinc-600" strokeWidth={2} />
            </div>
            <div className="flex-1 flex items-center justify-between">
              <p className="text-[13px] text-zinc-500 leading-6">
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-none w-8 h-6 flex justify-center items-center">
              <ShieldCheck className="w-3.5 h-3.5 text-[#E91E8C]" strokeWidth={2} />
            </div>
            <div className="flex-1 flex items-center justify-between">
              <p className="text-[13px] text-zinc-500 leading-6">

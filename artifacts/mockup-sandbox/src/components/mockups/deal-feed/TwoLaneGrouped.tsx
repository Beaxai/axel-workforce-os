...
export function TwoLaneGrouped() {
  return (
    <div className="min-h-screen bg-[#0d0d10] text-zinc-300 p-8 font-sans selection:bg-[#E91E8C]/30">
      <div className="max-w-[760px] mx-auto pb-20 flex flex-col gap-12">
        
        {/* Today */}
        <section className="flex flex-col">
          <h3 className="text-zinc-500 text-[11px] font-semibold uppercase tracking-widest mb-5 pl-12">Today</h3>
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Group 1: Stage Change + Open Task */}
            <div className="flex flex-col gap-1">
              <div className="flex gap-4 items-start relative z-10">
                <div className="flex-none w-8 relative flex justify-center">
                  <div className="absolute left-[15px] top-[12px] -bottom-[16px] w-px bg-white/[0.08]"></div>
                  <div className="h-6 flex items-center justify-center w-full relative z-10">
                    <div className="w-1 h-1 rounded-full bg-zinc-700 ring-4 ring-[#0d0d10]"></div>
                  </div>
                </div>
        ...
        {/* Yesterday */}
        <section className="flex flex-col">
          <h3 className="text-zinc-500 text-[11px] font-semibold uppercase tracking-widest mb-5 pl-12">Yesterday</h3>
          
          <div className="flex flex-col gap-6">
            {/* Group 3: System Create + Stage Change */}
            <div className="flex flex-col gap-1">
              <div className="flex gap-4 items-start relative z-10">
                <div className="flex-none w-8 relative flex justify-center">
                  <div className="absolute left-[15px] top-[12px] -bottom-[16px] w-px bg-white/[0.08]"></div>
            ...
            {/* Group 4: Deal Approved (Single item but aligned identically) */}
            <div className="flex flex-col gap-1">
              <div className="flex gap-4 items-start relative z-10">
                <div className="flex-none w-8 relative flex justify-center">
                  <div className="h-6 flex items-center justify-center w-full relative z-10">
                    <div className="w-1 h-1 rounded-full bg-[#E91E8C] ring-4 ring-[#0d0d10]"></div>
                  </div>
                </div>
                <div className="flex-1 flex items-center justify-between pl-2">
                  <p className="text-[13px] text-zinc-500 leading-6">

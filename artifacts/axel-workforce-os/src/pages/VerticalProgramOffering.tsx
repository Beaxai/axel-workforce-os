...
export default function VerticalProgramOffering() {
    ...
    <div style={{ maxWidth: 1200 }}>
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center", height: "100%", padding: "40px 48px", gap: 48,
          }}
        >
          <div
            style={{
              width: 80, height: 80, borderRadius: 20,
              background: "rgba(124,58,237,0.3)", backdropFilter: "blur(12px)",
              display: "flex", alignItems: "center", justifyContent: "center",
              flexShrink: 0, border: "1px solid rgba(124,58,237,0.4)",
            }}
          >
            <Icon style={{ width: 36, height: 36, color: "#A78BFA" }} />
          </div>
          ...
          <div style={{ maxWidth: 560 }}>
            <h1
              style={{
                ...
                marginBottom: 16, lineHeight: 1.2, textTransform: "uppercase",
                letterSpacing: "0.02em",
              }}
            >
              Integrated Workforce Solutions Built for {vertical.name}
            </h1>
            <p
              style={{
                fontSize: 14, color: "rgba(255,255,255,0.75)", margin: 0,
                lineHeight: 1.7, fontStyle: "italic",
              }}
            >
              {vertical.peoDescription}
            </p>
          </div>
        </div>
      </div>
                ...
                >
                  <span
                    style={{
                      ...
                      width: 5, height: 5, borderRadius: 999, background: "#7C3AED",
                    }}
                  />
                  {item}
                </li>
      ...
      <button
        ...
        style={{
          ...
          transition: "opacity 0.15s", marginBottom: 32,
        }}

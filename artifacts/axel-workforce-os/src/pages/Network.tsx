...
function AddPartnerModal({ partnerType, onClose, onSubmit }: { partnerType: string; onClose: () => void; onSubmit: (data: any) => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.7)" }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} style={{ width: "520px", maxHeight: "85vh", overflowY: "auto", background: "#111118", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "32px" }}>
